...
public class AdviceAround {
	...
	public void around1(ProceedingJoinPoint pjp) throws Throwable {
		...
		System.out.println("È¾´Ü°ü½É - around1 before...");
		pjp.proceed();
		System.out.println("È¾´Ü°ü½É - around1 after...");
	}
	
	@Around("pointcut2()")
	public void around2(ProceedingJoinPoint pjp) throws Throwable {
			
		System.out.println("È¾´Ü°ü½É - around2 before...");
		pjp.proceed();
		System.out.println("È¾´Ü°ü½É - around2 after...");
	}
